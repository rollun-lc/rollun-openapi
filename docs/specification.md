...
стандарт [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902/).
...
Повідомлення PATCH **ПОВИННО** відповідати специфікації [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902/)
