...
namespace Task\OpenAPI\V1\Client;
...
class Configuration
{
     ...
     * @var array
     */
    public static $additionalData = ['fileSummaryIdDelete'=>['className'=>'FileSummaryApi', 'returnType' => '\Task\OpenAPI\V1\Client\Model\DeleteResult','params' => [['paramName'=>'id','paramType'=>'string'],]],'fileSummaryIdGet'=>['className'=>'FileSummaryApi', 'returnType' => '\Task\OpenAPI\V1\Client\Model\TaskInfoResult','params' => [['paramName'=>'id','paramType'=>'string'],]],'fileSummaryPost'=>['className'=>'FileSummaryApi', 'returnType' => '\Task\OpenAPI\V1\Client\Model\TaskInfoResult','params' => [['paramName'=>'post_file_summary','paramType'=>'\Task\OpenAPI\V1\Client\Model\PostFileSummary'],]],];
     ...
     * @var string
     */
    protected $host = 'http://rollun-openapi/openapi/Task/v1';
    ...
    {
        $report  = 'PHP SDK (Task\OpenAPI\V1\Client) Debug Report:' . PHP_EOL;
