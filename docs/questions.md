...
те які методи доступні на даний URI, ні те що повернеться. Єдине знання доступне клієнт - це початковий URL та множина 
можливих медіа типів, що використовуються в цьому REST API. Openapi маніфести ломають цю концепцію, адже
