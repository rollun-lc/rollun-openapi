...
Кожен рівень містить інтерфейс, що буде оброблювати запит та структури даних необхідні для цього інтерфейсу. А також:
- за можливості, стандартні реалізації цього інтерфейсу, що будуть фактично адаптерами між рівнями.
...
Рівні з яких складається згенерований код:

| Рівень         | Функції                                                        | Поняття специфічні для рівня                                        |
|----------------|----------------------------------------------------------------|---------------------------------------------------------------------|
| 3. Rollun      | Реалізація максимальної підтримки специфікації нашої компанії. | Command, Handler, UseCases                          |
