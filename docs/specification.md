...
> 
> При цьому документ може мати дочірню колекцію, яка також буде містити документи.
...
| /customers/1/orders/2 | Отримання відомостей про замовлення 2 клієнта 1 | Помилка | Стволрення або повне оновлення відомостей про замовлення 2 клієнта 1 | Часткове оновлення замовлення 2 клієнта 1 | Видалення замовлення 2 клієнта 1 |
...
##### 3.3.5.3 Ідемпотентність скінченного автомата
...
##### 3.3.5.4 Перехід між стейджами скінченного автомата
*Правило*
...
| URI                 | GET                                         | POST                                      | PUT                                                 | PATCH   | DELETE                                 |
|---------------------|---------------------------------------------|-------------------------------------------|-----------------------------------------------------|---------|----------------------------------------|
| /customers/         | Отримання колекції усіх клієнтів            | Створення нового клієнта                  | Масоване оновлення колекції клієнтів                | Помилка | Видалення усіх клієнтів                |
| /customers/1/orders | Отримання колекції усіх замовлень клієнта 1 | Створення нового замовлення для клієнта 1 | Масоване оновлення колекції замовлень для клієнта 1 | Помилка | Видалення усіх замовлень для клієнта 1 |
