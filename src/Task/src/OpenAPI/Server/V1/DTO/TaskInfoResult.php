...
class TaskInfoResult
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\Task\OpenAPI\Server\V1\DTO\TaskInfo::class})
     * @DTA\Validator(name="Dictionary", options={"type":\Task\OpenAPI\Server\V1\DTO\TaskInfo::class})
     * @var \Task\OpenAPI\Server\V1\DTO\TaskInfo
     */
    public $data;
    /**
