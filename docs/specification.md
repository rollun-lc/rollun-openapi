...
| X-Lifecycle-Token | **Дозволяє повертати 304 Not Modified, якщо вміст не змінено.** <br/><br/> Використовується в [content-based умовних запитах](#1142-content-based)                                                                                          |
...
> У відповідь на створення скінченного автомата ми отримуємо лише його ідентифікатор у заголовку Location, а не повну 
> сутність.
...
Сервер своєю чергою перевірить, якщо відправленний Etag збігається з тим, що зараз зберігається на сервері, то виконає
