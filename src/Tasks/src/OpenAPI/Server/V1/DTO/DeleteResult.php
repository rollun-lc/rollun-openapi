...
class DeleteResult
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\Tasks\OpenAPI\Server\V1\DTO\Delete::class})
     * @DTA\Validator(name="Dictionary", options={"type":\Tasks\OpenAPI\Server\V1\DTO\Delete::class})
     * @var \Tasks\OpenAPI\Server\V1\DTO\Delete
     */
    public $data;
    /**
