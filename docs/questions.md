...
яка скоріше за все порушить роботу з багатьма стороніми бібліотеками, що працюють з openapi (той самий swagger-ui),
а також потребує визначення правил наслідування (що може бути нетревіальною задачею) та створення механізмів контролю, 
що вони дотримуються. Тому я б розв'язував ці проблеми все ж окремо
