...
class HelloResult
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\HelloUser\OpenAPI\Server\V1\DTO\Hello::class})
     * @DTA\Validator(name="Dictionary", options={"type":\HelloUser\OpenAPI\Server\V1\DTO\Hello::class})
     * @var \HelloUser\OpenAPI\Server\V1\DTO\Hello
     */
    public $data;
    /**
