...
namespace Tasks\OpenAPI\Client\V1;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://rollun-openapi/openapi/Tasks/v1/FileSummary';
    ...
    {
        $report  = 'PHP SDK (Tasks\OpenAPI\Client\V1) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "http://rollun-openapi/openapi/Tasks/v1/FileSummary",
