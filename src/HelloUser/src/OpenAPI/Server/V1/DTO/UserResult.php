...
class UserResult
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\HelloUser\OpenAPI\Server\V1\DTO\User::class})
     * @DTA\Validator(name="Dictionary", options={"type":\HelloUser\OpenAPI\Server\V1\DTO\User::class})
     * @var \HelloUser\OpenAPI\Server\V1\DTO\User
     */
    public $data;
    /**
