...
можемо створити ресурс-контролер /video/{id}/convert. Процес конвертації запускається POST запитом з відомостями про 
...
- **POST**. Створює новий ресурс за вказаним URI. Текст запиту містить відомості про новий ресурс. Також POST можна
використовувати для старту операції, які не належать безпосередньо до створення ресурсу.
