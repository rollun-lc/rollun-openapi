...
В маніфесті не можна явно вказати те, які сервера є зеркалами один одного, а які просто різні. 
Для того, щоб можна було однозначно визначити це, можна зробити кастомний атрибут, яки би вказував на те, які
сервера є дзеркалами один одного, а які ні. Наприклад назвемо його `x-server-mirrors`:
