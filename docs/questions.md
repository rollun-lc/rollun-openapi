...
за можливості та потреби, стандартні реалізації цього інтерфейсу, що будуть фактично адаптерами між рівнями.

> Слово запит вжито в загальному сенсі, як прохання щось виконати. Тобто це не завжди http запит. Наприклад на 
> останньому рівні, замість слова запит(Request), використовується Command, щоб якомога більше абстрагувати його від 
> http рівня.
...
Але обмежень немає, та за потреби код може писатись бід будь-який рівень. Наприклад можна замінити бібліотеку, якою
