...
/**
 * @property \Articles\OpenAPI\V1\DTO\Task $data
 * @property array $messages
 */
class TaskResult implements \IteratorAggregate, \JsonSerializable
{
    /**
     * @ODTA\Data(field="data", required=false)
     * @DTA\Strategy(name="Object", options={"type":\Articles\OpenAPI\V1\DTO\Task::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\Articles\OpenAPI\V1\DTO\Task::class})
     * @var \Articles\OpenAPI\V1\DTO\Task
     */
    private \Articles\OpenAPI\V1\DTO\Task $data;
    /**
    ...
    public function getData(): \Articles\OpenAPI\V1\DTO\Task
    {
        return $this->data;
    }

    public function setData(\Articles\OpenAPI\V1\DTO\Task $data): self
    {
        $this->data = $data;
        return $this;
    }
