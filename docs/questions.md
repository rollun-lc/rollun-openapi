...
для клієнта і сервера, або вказувати різні версії в одному маніфесті (можна створити кастомне поле для цього). Обидва 
цих варіанти на мою думку будуть приводити до складності в менеджменті маніфестів та плутати програмістів. А саме:
...
зворотну сумісність тоді, коли вона це робить хоча б для однієї зі сторін (тобто або для клієнта або для сервера).
...
будуть описані талі). Приклади змін, що порушують зворотну сумісність:
- Змінна типу поля
