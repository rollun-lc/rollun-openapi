...
abstract class ConfigurationAbstract implements ConfigurationInterface
{
     ...
     *
     * @param ConfigurationAbstract $config An instance of the Configuration Object
     *
     * @return void
     */
     ...
     *
     * @param $index int array index of the host settings
     * @param $variables array|null hash of variable and the corresponding value (optional)
    ...
    abstract public function getHostSettings();

    abstract public static function toDebugReport();
}