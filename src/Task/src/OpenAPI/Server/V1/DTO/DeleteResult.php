...
class DeleteResult
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\Task\OpenAPI\Server\V1\DTO\Delete::class})
     * @DTA\Validator(name="Dictionary", options={"type":\Task\OpenAPI\Server\V1\DTO\Delete::class})
     * @var \Task\OpenAPI\Server\V1\DTO\Delete
     */
    public $data;
    /**
